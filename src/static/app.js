            ...
            <ul class="participants-list">
              ${details.participants.map((participant) => `
                <li>
                  ...
                  <button class="delete-participant" type="button" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant}" title="Remove participant">&times;</button>
                </li>
              `).join("")}
            </ul>
          </div>
